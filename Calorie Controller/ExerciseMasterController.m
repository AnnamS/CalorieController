...
@interface ExerciseMasterController ()
{
...
@implementation ExerciseMasterController
...
-(void)updateDateList
{
    ...
    for(Meal *workout in workoutRecords)
    {
        if(![self.dates containsObject:workout.date])
        {
            [self.dates addObject:workout.date];
        }
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.exerciseDelegate exerciseMasterController:self didChooseDate:cell.lblDate.text];
